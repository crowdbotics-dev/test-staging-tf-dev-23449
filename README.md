...
## Project Structure
    ...
    ├── test_staging_tf_dev_23449  # Django project configurations
...
1. Clone this repo and `cd test_staging_tf_dev_23449`
...
2. Clone this repo and `cd test_staging_tf_dev_23449`
